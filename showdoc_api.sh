...
# 
api_key="3c863d0f43ed6b0f01cc2d1819fdfcae1874421469" 			#api_key
api_token="85ebea50239d884054a6d4099198a29b912817385" 	#api_token
url="http://api-docs.ezrpro.com/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
